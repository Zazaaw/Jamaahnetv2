...
import { Calendar, DollarSign, Store, ChevronRight, Bell, Sparkles, TrendingUp, MessageCircle, ShoppingBag, Heart, Users, Plus, Bookmark, Repeat2, Share2 } from 'lucide-react';
...
export default function HomeScreen({ 
  ...
  const fetchTimeline = async () => {
    try {
      // Fetch from API database instead of localStorage
      const response = await fetch(
